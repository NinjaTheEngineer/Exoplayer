...
public class SendVideoStartLoadUseCase extends Interactor {
    ...
    @Inject
    public SendVideoStartLoadUseCase(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, VideoEventsRepository repository) {
