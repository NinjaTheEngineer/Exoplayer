...
public class SendShowFirstFrameUseCase extends Interactor {
    ...
    @Inject
    public SendShowFirstFrameUseCase(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, VideoEventsRepository repository) {
